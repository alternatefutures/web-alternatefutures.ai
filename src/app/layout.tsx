...
export const metadata: Metadata = {
  ...
  description: "The first comprehensive standards framework and toolset that ensures AI technology serves human flourishing. Our platform enables the creation of adaptive AI products that anticipate user needs while respecting human agency.",
  icons: {
    icon: [
